...
namespace FlexBackend.USER.Rcl.Migrations
{
    /// <inheritdoc />
...
");
			...
			migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reviser = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserNumberId = table.Column<int>(type: "int", nullable: false, defaultValueSql: "NEXT VALUE FOR dbo.UserNumberSequence"),
                    ...
                    MemberRankId = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ReferralCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    UsedReferralCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RevisedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
