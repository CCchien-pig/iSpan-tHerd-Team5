...
public partial class ProdProduct
{
    ...
    public virtual ICollection<ProdProductLike> ProdProductLikes { get; set; } = new List<ProdProductLike>();

    public virtual ICollection<ProdProductQuestion> ProdProductQuestions { get; set; } = new List<ProdProductQuestion>();

    public virtual ICollection<ProdProductReview> ProdProductReviews { get; set; } = new List<ProdProductReview>();

    public virtual ICollection<ProdProductSku> ProdProductSkus { get; set; } = new List<ProdProductSku>();
