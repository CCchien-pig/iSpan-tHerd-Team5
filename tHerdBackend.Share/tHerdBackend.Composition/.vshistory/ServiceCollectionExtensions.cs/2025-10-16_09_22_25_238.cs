...
namespace tHerdBackend.Composition
{
    public static class ServiceCollectionExtensions
    {
        ...
        /// </summary>
        public static IServiceCollection AddtHerdBackend(
        this IServiceCollection services,
        IConfiguration config,
        Action<tHerdBackendOptions>? configure = null)
        {
            /*
                ...
                Action<tHerdBackendOptions>? configure：讓呼叫端（Host 專案）決定要不要啟用一些「專案級選項」，例如開發期功能（假資料、Swagger 等）。
             
             */

            var options = new tHerdBackendOptions();
    ...
    public sealed class tHerdBackendOptions
    {
